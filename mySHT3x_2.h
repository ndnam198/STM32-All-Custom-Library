 ...
 * 
 */
#ifndef __MY_SHT3x_2_H /* __MY_SHT3x_H */
#define __MY_SHT3x_2_H
...
// NO_ERROR = no error
//-----------------------------------------------------------------------------
e_Error SHT3x_GetTempAndHumi(float *temperature, float *humiditiy,
...
// NO_ERROR = no error
//-----------------------------------------------------------------------------
e_Error SHT3x_GetTempAndHumiClkStretch(float *temperature, float *humiditiy,
...
// NO_ERROR = no error
//-----------------------------------------------------------------------------
e_Error SHT3x_GetTempAndHumiPolling(float *temperature, float *humiditiy,
                                    e_SHT3x_Repeatability repeatability,
                                    uint8_t timeout);
//=============================================================================
